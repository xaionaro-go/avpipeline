...
func TestReaderLoop_InputChannelClosed(t *testing.T) {
	...
	err := readerLoop(context.Background(), inputCh, k, outputCh, counters, &firstObservationTracker{})
...
func TestReaderLoop_ContextCancelled(t *testing.T) {
	...
	err := readerLoop(ctx, inputCh, k, outputCh, counters, &firstObservationTracker{})
