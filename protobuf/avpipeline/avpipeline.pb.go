...
type AutoBitrateCalculator struct {
	...
	//	*AutoBitrateCalculator_ConstantQueueSize
...
func (x *AutoBitrateCalculator) GetConstantQueueSize() *AutoBitrateCalculatorConstantQueueSize {
	if x != nil {
		if x, ok := x.AutoBitrateCalculator.(*AutoBitrateCalculator_ConstantQueueSize); ok {
			return x.ConstantQueueSize
		}
	}
	return nil
}
...
type AutoBitrateCalculator_ConstantQueueSize struct {
	ConstantQueueSize *AutoBitrateCalculatorConstantQueueSize `protobuf:"bytes,2,opt,name=constantQueueSize,proto3,oneof"`
}

func (*AutoBitrateCalculator_Thresholds) isAutoBitrateCalculator_AutoBitrateCalculator() {}

func (*AutoBitrateCalculator_ConstantQueueSize) isAutoBitrateCalculator_AutoBitrateCalculator() {}
...
type AutoBitrateCalculatorConstantQueueSize struct {
	...
	MovingAverage  *MovingAverageConfig   `protobuf:"bytes,2,opt,name=movingAverage,proto3" json:"movingAverage,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *AutoBitrateCalculatorConstantQueueSize) GetMovingAverage() *MovingAverageConfig {
	if x != nil {
...
var file_avpipeline_proto_rawDesc = string([]byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xe3, 0x01, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x6f, 0x42, 0x69, 0x74,
	...
	,
	...
	0x4d, 0x53, 0x12, 0x45, 0x0a, 0x0d, 0x6d, 0x6f, 0x76, 0x69, 0x6e, 0x67, 0x41, 0x76, 0x65, 0x72,
	0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x61, 0x76, 0x70, 0x69,
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x2e, 0x4d, 0x6f, 0x76, 0x69, 0x6e, 0x67, 0x41, 0x76, 0x65,
	0x72, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0d, 0x6d, 0x6f, 0x76, 0x69,
	0x6e, 0x67, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69, 0x74,
...
var file_avpipeline_proto_goTypes = []any{
	...
	(*AutoBitrateCalculatorConstantQueueSize)(nil), // 11: avpipeline.AutoBitrateCalculatorConstantQueueSize
...
var file_avpipeline_proto_depIdxs = []int32{
	...
	11, // 12: avpipeline.AutoBitrateCalculator.constantQueueSize:type_name -> avpipeline.AutoBitrateCalculatorConstantQueueSize
	...
	10, // 15: avpipeline.AutoBitrateCalculatorConstantQueueSize.movingAverage:type_name -> avpipeline.MovingAverageConfig
...
func file_avpipeline_proto_init() {
	...
	file_avpipeline_proto_msgTypes[6].OneofWrappers = []any{
		...
		(*AutoBitrateCalculator_ConstantQueueSize)(nil),
	}
