...
- Everytime there is something difficult to understand: try to understand it and document. Create files .github/explanations/<package-dir>/<package-name>.<flow-title>.md with the summary of how the flow works.
